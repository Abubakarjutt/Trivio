...
const PUBLIC_PREFIXES = ["/login", "/register", "/forgot-password", "/reset-password", "/privacy", "/api/auth", "/api/trpc", "/api/mobile", "/pricing", "/blog", "/api/webhooks", "/api/email", "/api/health"];
